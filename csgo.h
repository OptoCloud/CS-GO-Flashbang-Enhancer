...
namespace offsets
{
    ...
    constexpr ptrdiff_t dwEntityList = 0x4DA215C;
    constexpr ptrdiff_t dwForceAttack = 0x31D2690;
    constexpr ptrdiff_t dwForceAttack2 = 0x31D269C;
    constexpr ptrdiff_t dwForceBackward = 0x31D26CC;
    constexpr ptrdiff_t dwForceForward = 0x31D26A8;
    constexpr ptrdiff_t dwForceJump = 0x524BF4C;
    constexpr ptrdiff_t dwForceLeft = 0x31D26C0;
    constexpr ptrdiff_t dwForceRight = 0x31D26E4;
    constexpr ptrdiff_t dwGameDir = 0x627780;
    constexpr ptrdiff_t dwGameRulesProxy = 0x52BF23C;
    constexpr ptrdiff_t dwGetAllClasses = 0xDB0FC4;
    constexpr ptrdiff_t dwGlobalVars = 0x588CF0;
    constexpr ptrdiff_t dwGlowObjectManager = 0x52EA5D0;
    constexpr ptrdiff_t dwInput = 0x51F3720;
    constexpr ptrdiff_t dwInterfaceLinkList = 0x945514;
    ...
    constexpr ptrdiff_t dwPlayerResource = 0x31D0A10;
    constexpr ptrdiff_t dwRadarBase = 0x51D6ED4;
    constexpr ptrdiff_t dwSensitivity = 0xDA02AC;
    constexpr ptrdiff_t dwSensitivityPtr = 0xDA0280;
    constexpr ptrdiff_t dwSetClanTag = 0x8A1B0;
    constexpr ptrdiff_t dwViewMatrix = 0x4D93A74;
    constexpr ptrdiff_t dwWeaponTable = 0x51F41E0;
    constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
    constexpr ptrdiff_t dwYawPtr = 0xCF6F0002;
    constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD93D18;
    constexpr ptrdiff_t dwbSendPackets = 0xD76DA;
    ...
    constexpr ptrdiff_t m_pitchClassPtr = 0x51D7170;
    ...
    constexpr ptrdiff_t is_c4_owner = 0x3BCB10;
    constexpr ptrdiff_t force_update_spectator_glow = 0x3AFECA;
    constexpr ptrdiff_t anim_overlays = 0x2980;
    constexpr ptrdiff_t m_flSpawnTime = 0xA370;
    constexpr ptrdiff_t find_hud_element = 0x30BCF980;
